      ...
      <Container>      
        <Row>
          <Col>                          
            ...
            <ul>
              <li>Go to <a href="https://wallet.myhush.network">https://wallet.myhush.network</a></li>
            ...
            <ul>
              <li>If you've created a wallet on <a href="https://wallet.myhush.network">https://wallet.myhush.network</a> via the secret phrase, simply re-enter the same phrase.</li>
